...
class ListSuraJuzPage extends StatefulWidget {
  @override
  final Color _darkColor = Colors.teal;
  final Color _lightColor = Colors.teal[50];
...
class ListSuraPageState extends State<ListSuraJuzPage> {
  ...
  void initState() {
    super.initState();
    _suraList = GetIt.I<QuranData>().suraListJuzAmma;
