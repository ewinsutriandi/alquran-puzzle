...
class ListSuraProgressJuz extends StatefulWidget {
  final List<Sura> suraList;
  ListSuraProgressJuz({this.suraList});
  ...
  @override
  ListSuraProgressJuzState createState() => ListSuraProgressJuzState();
}

class ListSuraProgressJuzState extends State<ListSuraProgressJuz> {
    ...
    return Container(
      ...
      child: Column(
          ...
          children: <Widget>[
            ...
            Text(
              '${stats.suraSolved}/${stats.totalSura}',
              style: widget.captionStyle,
            ),
            SizedBox(
              height: 4,
